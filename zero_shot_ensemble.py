...
model_dir: str = '/COVID_8TB/sangjoon/chexzero_checkpoint/20230313_fusion_1e-4_impression/best/'  # where pretrained models are saved (.pt)
...
Mean_auc = (Atelectasis_auc + Cardiomegaly_auc + Edema_auc + Effusion_auc) / 4.
